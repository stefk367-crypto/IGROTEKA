...
const THEMES = {
  ...
  sakura:   { name: 'Сакура',    price: 50,  cyan: '#f2a6c9', magenta: '#e85d94', yellow: '#ffd1e0' },
  midnight: { name: 'Північ',    price: 70,  cyan: '#4a5fc1', magenta: '#7b3fe4', yellow: '#2b2f5e' },
  citrus:   { name: 'Цитрус',    price: 45,  cyan: '#ffb347', magenta: '#ff6f3c', yellow: '#c8e066' },
  forest:   { name: 'Ліс',       price: 55,  cyan: '#4caf7d', magenta: '#2e7d4f', yellow: '#a8d08d' },
  candy:    { name: 'Цукерка',   price: 65,  cyan: '#ff9ecf', magenta: '#c58cf0', yellow: '#fff07a' },
  volcano:  { name: 'Вулкан',    price: 90,  cyan: '#ff4d4d', magenta: '#992d1f', yellow: '#ff9d3b' },
  arctic:   { name: 'Арктика',   price: 60,  cyan: '#b8e6f0', magenta: '#6fa8c9', yellow: '#f0faff' },
  royal:    { name: 'Королівський', price: 120, cyan: '#9b59d0', magenta: '#5b2c8a', yellow: '#e8c96b' },
  sunset:   { name: 'Захід сонця', price: 85, cyan: '#ff8c69', magenta: '#e0559b', yellow: '#ffcf5c' },
  mint:     { name: "М'ята",     price: 50,  cyan: '#7fd9c4', magenta: '#4fae94', yellow: '#e0fff5' }
};
